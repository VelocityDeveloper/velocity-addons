...
?>
                                    ...
                                    <?php foreach ($contacts as $index => $contact) : ?>
                                        ...
                                        <div class="wa-contact-item">
                                            <div class="wa-contact-row">
                                                ...
                                                <span tabindex="0" class="wa-remove-contact<?php echo $hide_remove; ?>">
    ...
    public static function add_floating_scrolltop()
    {
        ...
        ?>
            <div class="scroll-to-top floating-button <?php echo $scrolltotop_position === 'left' ? 'left' : 'right'; ?>" data-scrolltotop-position="<?php echo esc_attr($scrolltotop_position === 'left' ? 'left' : 'right'); ?>" style="display: none;">
